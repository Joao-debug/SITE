...
VALUES
    (
        '2020-02-05 14:31:00', 'Perigo Virtual',
        'Hoje tem acontecido muitos casos de perda de contas de bancos, perca de senhas, invasão de computadores etc. Isso se dá pela falta de cuidado ao navegar na internet, ao clicar em um Pop-up ou a entrar em sites sem seguranças.', '3'
    ),
